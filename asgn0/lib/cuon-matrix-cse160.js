...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        let xval = other1.elements[1] * other2.elements[2] - other1.elements[2] * other2.elements[1];
        let yval = other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2];
        let zval = other1.elements[0] * other2.elements[1] - other1.elements[1] * other2.elements[0];
        let v3 = new Vector3([xval, yval, zval]); // Modify this line to calculate cross product between other1 and other2.
